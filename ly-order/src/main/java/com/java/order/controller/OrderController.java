...
import com.java.order.pojo.Order;
import com.java.po.PageResult;
import com.java.order.service.OrderService;
import com.java.utils.PayHelper;
import com.java.utils.PayState;
...
public class OrderController {
     ...
     */
    @PostMapping
    @ApiOperation(value = "创建订单接口，返回订单编号", notes = "创建订单")//方法说明
    @ApiImplicitParam(name = "order", required = true, value = "订单的json对象,包含订单条目和物流信息")//方法需要的参数说明 required为true是：必须传参
